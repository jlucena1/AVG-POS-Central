page 50006 "Loyalty Trans. Line Entries"
{
    ApplicationArea = All;
    Caption = 'Loyalty Trans. Line Entries';
    PageType = List;
    ...
    DeleteAllowed = false;
    ShowFilter = false;
    SourceTableView = sorting("Store No.", "POS Terminal No.", "Transaction No.", "Line No.") order(ascending) where("Process Type" = filter("Loyalty Add Member" | "Loyalty Earn Points" | "Loyalty Redeem Points"));
    layout
    {
        area(content)
        {
